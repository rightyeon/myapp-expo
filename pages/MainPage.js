  ...
  return ready ? <Loading/> :  (
    ...
    */
    <ScrollView style={styles.container}>
        ...
        <TouchableOpacity onPress={()=> { navigation.navigate('AboutPage')} } style={styles.aboutBtn}><Text style={styles.textWhite}>소개 페이지</Text></TouchableOpacity>
...
const styles = StyleSheet.create({
  aboutBtn : {
    width:100, height:40, backgroundColor:'deeppink',  alignSelf:'flex-end', marginRight:20, marginTop:10, borderRadius:10
  },
  textWhite : { color:"#ffffff", textAlign:'center', lineHeight:40 },
  container: {
    //앱의 배경 색
    backgroundColor: '#fff',
  },
